...
seattle = Location.create(id: 1, user_id: 1, loc_type: "public", lat: 47.6062, lng: -122.3321, address: "Seattle, WA")
portland = Location.create(id: 2, user_id: 2, loc_type: "private", lat: 45.5122, lng: -122.6587, address: "Portland, WA")
