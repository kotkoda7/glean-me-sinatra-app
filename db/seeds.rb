...
portland = Location.create(id: 2, user_id: 2, edible: "Blueberry Bush", loc_type: "private", lat: 45.5122, lng: -122.6587, address: "Portland, WA")
bham = Location.create(id: 3, user_id: 2, edible: "Blackberry Bush", loc_type: "private", lat: 44.33, lng: -120.44, address: "Bellingham, WA")